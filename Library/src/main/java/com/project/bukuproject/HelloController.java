...
public class HelloController implements Initializable {
     ...
     *
     * @param searchTerm The term to search for (title or author).
    ...
    private boolean containsAllWordsIgnoreCase(String text, String search) {
        ...
        for (String searchWord : searchWords) {
            ...
            // Jika setidaknya satu kata tidak cocok, maka teks tidak memenuhi kriteria
            if (!wordFound) {
                return false;
            }
        }
     ...
     * Load the search results into the bookContainer.
     *
     * @param searchResults List of books to display.
     */
