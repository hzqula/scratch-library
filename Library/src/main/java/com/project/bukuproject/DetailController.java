...
public class DetailController implements Initializable {
    ...
    private Set<String> daftarRekomendasiDitampilkan = new HashSet<>();
    private Set<String> daftarGenreDitampilkan = new HashSet<>();
    private Set<String> daftarPenulisDitampilkan = new HashSet<>();
